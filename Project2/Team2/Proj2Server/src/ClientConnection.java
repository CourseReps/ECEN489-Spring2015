...
public class ClientConnection implements Runnable {
    ...
    public void run() {
        ...
        try {
            System.out.print("Created clientconnection\n");
...
//                }
                ...
                if (stringIn != null && stringIn.length() > 0) {
                    ...
                    System.out.print("jsonString" + stringIn + "\n");
...
//                        }
                        ...
                        System.out.print("\n\n\nRECEIVED FILENAME: " + JSONmap.get("filename") + "\n\n\n");
                    }
                }
            }
