...
public class HashMachine {
    ...
    public static boolean securelyValidatePassword(String originalPassword, String storedPassword, String storedSalt) throws NoSuchAlgorithmException
    {
        byte[] salt = getByteArray(storedSalt);
        byte[] storedHash = getByteArray(storedPassword);
        byte[] testHash = getByteArray(get_SHA_256_SaltedPassword(originalPassword, storedSalt));
