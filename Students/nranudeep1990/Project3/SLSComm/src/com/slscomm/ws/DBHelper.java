...
public class DBHelper {
    ...
    public void openDB(){
        try {
            ...
            c = DriverManager.getConnection("jdbc:sqlite:/home/blade/Project3/Database/Project3.db");
//            c = DriverManager.getConnection("jdbc:sqlite:/var/lib/tomcat7/webapps/Project3.db");
            stmt = c.createStatement();
        }
        catch (Exception e){
        	logger.error("Error in making DB connection", e);
//            e.printStackTrace();
        }
...
*/
        	...
        	logger.error("Error in DBHelper", e);
//            e.printStackTrace();
        }
...
//            e.printStackTrace();
    ...
    public void addLocation(String name, double latitude, double longitude, String image){
        try{
        	...
        	logger.error("Error in ADD location", e);
//            e.printStackTrace();
        }
    ...
    public void deleteLocation(int locationID){
        try{
        	...
        	logger.error("Error in deleteLocation", e);
//            e.printStackTrace();
        }
    ...
    public void addFriend(int userID, int friendID){
        try{
            ...
            */
        	...
        	logger.error("Error in add friend", e);
//            e.printStackTrace();
        }
    }
    public void deleteFriend(int userID, int friendID){
        try{
        	...
        	logger.error("Error in deleteFriend", e);
//            e.printStackTrace();
        }
    ...
    public void checkIn(int userID, int locationID, int timestamp, String method){
        try{
        	...
        	logger.error("Error in checkIn", e);
            e.printStackTrace();
        }
    ...
    public String getUserName(int userID){
        try{
        	...
        	logger.error("Error in getUsername", e);
            e.printStackTrace();
        }
        return null;
    }
...
//            e.printStackTrace();
    ...
    public int getUserIDByName(String name){ //identical Names fail
        ...
        try {
        	...
        	logger.error("Error get user by name", e);
//            e.printStackTrace();
        }
        return userID;
    ...
    public int getLocationIDByName(String locationName){//identical location names fail
        ...
        try {
        	...
        	logger.error("error at locationby name", e);
//            e.printStackTrace();
        }
        return locID;
    ...
    public int getUserIDBySessionID(String sessionID){
        ...
        try {
        	...
        	logger.error("Error in getUserId by session", e);
//            e.printStackTrace();
        }
        return userID;
    ...
    public String getPassByUserName (String userName) {
        ...
        try {
        	...
        	logger.error("Error in getPass Username", e);
//            e.printStackTrace();
        }
        return pass;
    }
    public void addSessionID (String userName, String ID) {
        try {
        	...
        	logger.error("Error in add session", e);
//            e.printStackTrace();
        }
    }
    public void resetSessionID (String userName) {
        ...
        try {
        	...
        	logger.error("Error in reset session", e);
//            e.printStackTrace();
        }
    }
    //End added by Trevor
    ...
    public String getSessionIDByUserName(String userName) {
        ...
        try {
        	...
        	logger.error("error in get Sessionby Id", e);
//            e.printStackTrace();
        }
        return sessionID;
    }
    ...
    public ArrayList<String> getFriends(int userID){
        ...
        try {
        	...
        	logger.error("Error in get Friends", e);
//            e.printStackTrace();
        }
        return null;
    }
    public ArrayList<CheckIn> getCheckInByLocation(int locationID){
        ...
        try {
        	...
        	logger.error("Error in getCheckINby location", e);
//            e.printStackTrace();
        }
        return null;
    ...
    public ArrayList<CheckIn> getFriendsCheckInByLocation(int locationID, int userWithFriends){
        ...
        try {
        	...
        	logger.error("error in getfriendsbylocation", e);
//            e.printStackTrace();
        }
        return null;
    ...
    public ArrayList<CheckIn> getCheckInByUser(int userID){
        ...
        try {
        	...
        	logger.error("Error in GetCheck In User", e);
//            e.printStackTrace();
        }
        return null;
