...
public class Digit_Recognition extends Activity implements CvCameraViewListener2, OnTouchListener {
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if (count == 0) {
            ...
            // Step-4 : filter contours by their position
                        ...
                        java.util.Arrays.sort(centroidx,
                        ...
                        MatOfPoint2f approxCurve = new MatOfPoint2f();
                            ...
                            for( int i = 0; i < mContours.size(); i++ )
                            {
                                ...
                                if ((area > 500) ) {
                                    ...
                                    double approxDistance = Imgproc.arcLength(contour2f, true)*0.03;//0.02
    ...
    public void displayalertdialog(){
                    ...
                    else if (s.toString().equals("6")){loc = "Zachary";displayalertdialog1();}
                    else if (s.toString().equals("7")){loc = "Home";displayalertdialog1();}
                    else if (s.toString().equals("8")){loc = "EIC";displayalertdialog1();}
                    else if (s.toString().equals("9")){loc = "Home";displayalertdialog1();}
                    else {
                        displayalertdialog2();
                    }
