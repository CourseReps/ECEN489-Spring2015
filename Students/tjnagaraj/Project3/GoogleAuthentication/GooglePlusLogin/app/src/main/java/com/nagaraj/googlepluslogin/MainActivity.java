package com.nagaraj.googlepluslogin;
...
public class MainActivity extends Activity implements OnClickListener, ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<People.LoadPeopleResult> {
    ...
    private TextView username, emailLabel,friends;
    ...
    public void onConnected(Bundle arg0) {
        ...
        Plus.PeopleApi.loadConnected(mGoogleApiClient)
                .setResultCallback((com.google.android.gms.common.api.ResultCallback<com.google.android.gms.plus.People.LoadPeopleResult>) this);
    }
    ...
    String friendlist="Friends list: \n";
        if (peopleData.getStatus().getStatusCode() == CommonStatusCodes.SUCCESS) {
            PersonBuffer personBuffer = peopleData.getPersonBuffer();
            try {
                int count = personBuffer.getCount();
                for (int i = 0; i < count; i++) {
                    friendlist = friendlist+(i+1)+". "+personBuffer.get(i).getDisplayName()+"\n";
