...
public class MainActivity extends FragmentActivity implements
    ...
    private static final String WEB_CLIENT_ID = "536480597247-n9q3up2kt9ghal6ag9gi8mddvcupvhds.apps.googleusercontent.com";

    // Base URL for your token exchange server, no trailing slash.
    private static final String SERVER_BASE_URL = "http://elcloudo.tamu.edu:8080";
...
//    private static final String SELECT_SCOPES_URL = SERVER_BASE_URL + "/selectscopes";
    ...
    private static final String SELECT_SCOPES_URL = SERVER_BASE_URL;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.friends_button).setVisibility(View.INVISIBLE);
        // CheckBox listeners
        findViewById(R.id.request_server_auth_code).setVisibility(View.INVISIBLE); // disabling this feature for now
        ...
        if (!mGoogleApiClient.isConnecting()) {
            ...
            switch (v.getId()) {
                ...
                case R.id.friends_button:
                    // Call addFriendstoServer method
                    addFriendstoServer();
                    break;
    ...
    public void addFriendstoServer(){
        try {
        ...
        AddFriendsBackground addFriendsBackground=new AddFriendsBackground(username,password,mCirclesList);
        addFriendsBackground.execute();
      return;
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        findViewById(R.id.friends_button).setVisibility(View.VISIBLE);
    ...
    public CheckResult onCheckServerAuthorization(String idToken, Set<Scope> scopeSet) {
        ...
        if (!mServerHasToken) {
            Log.i(TAG, "Hi I'm in oncheckServerAuthorization " );
    ...
    public boolean onUploadServerAuthCode(String idToken, String serverAuthCode) {
        ...
        try {
           ...
           System.out.println("IDToken:  "+idToken);
            System.out.println("ServerAuthCode:  "+serverAuthCode);
