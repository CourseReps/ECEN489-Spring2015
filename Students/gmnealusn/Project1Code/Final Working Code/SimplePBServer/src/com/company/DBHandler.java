...
public class DBHandler {
    ...
    private void checkPBID()throws Exception{

        DatabaseMetaData dbm = c.getMetaData();
        ResultSet tables = dbm.getTables(null, null, "PBID", null);
    ...
    private void checkLocalPBID()throws Exception{
        ...
        if (tables.next()) {
            ...
            //long PBID = Math.abs(new HighQualityRandom().nextLong());
            sqlCommand = "INSERT INTO PBID (ID, PBID) VALUES ( 1, 'PB4' );";
            stmt.executeUpdate(sqlCommand);
