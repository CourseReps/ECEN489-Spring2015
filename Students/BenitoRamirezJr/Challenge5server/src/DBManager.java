...
public class DBManager implements Runnable {
    ...
    final String DB_NAME = "locationdb.db";
    ...
    public void run() {
        try {
            ...
            connection = DriverManager.getConnection("jdbc:sqlite:C:\\Users\\Benito\\Desktop\\SQLite\\" + DB_NAME);
            //C:\Users\Benito\Desktop\SQLite
